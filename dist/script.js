...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunction = function calcFunction() {
    ...
    } else if (promocodeBlock.value == 'NataDav') {
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      item.previousElementSibling.textContent = 'File is not choosen';
    });
  };
...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  ...
  btn.addEventListener('click', function () {
    cards.forEach(function (card) {
      card.classList.remove('hidden-lg', 'hidden-md', 'hidden-sm', 'hidden-sm');
